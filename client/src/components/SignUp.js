                        ...
                        <div className="flex flex-wrap items-center -mx-4">
                            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
                                <div className="max-w-md">
                                    <NavLink to='/'><img className="h-40" src={logo} alt="" width="auto" /></NavLink>
                            ...
                            <div className="w-full lg:w-1/2 px-4">
                                <div className="px-6 lg:px-20 py-12 lg:py-24 bg-gray-600 rounded-lg">
                                    ...
                                    <h3 className="mb-10 text-2xl text-white font-bold font-heading">Sign Up</h3>
                                    <div className="flex items-center pl-6 mb-3 bg-white rounded-xl">
                                        ...
                                        <input
                                            ...
                                            type="text" placeholder="Username" name="username" onChange={handleTextChange} />
                                    </div>
                                    <div className="flex items-center pl-6 mb-3 bg-white rounded-xl">
                                        <span className="inline-block pr-3 py-2 border-r border-gray-50">
                                        ...
                                        <input
                                            className="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none"
                                            type="password" placeholder="Password" name="password" onChange={handleTextChange} />
                                    </div>
                                    <div className="flex items-center pl-6 mb-6 bg-white rounded-xl">
                                        <span className="inline-block pr-3 py-2 border-r border-gray-50">
                                            <svg className="w-5 h-5" width="20" height="21" viewBox="0 0 20 21" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                        ...
                                        <input
                                            className="w-full pl-4 pr-6 py-4 font-bold placeholder-gray-900 rounded-r-full focus:outline-none"
                                            type="password" placeholder="Confirm password" name="repeatedPassword" onChange={handleTextChange} />
                                    </div>
