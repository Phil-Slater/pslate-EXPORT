    ...
    <div>
      ...
      <div className="relative container px-4 pt-12 md:pt-20 mx-auto">
        ...
        <div className="relative flex flex-wrap -mx-4 items-start">
          ...
          <div className="flex flex-col px-12 mx-20 sm:-mx-8"><a
            className="inline-block px-20 py-5 text-lg text-white text-center font-bold bg-blue-500 mb-6 hover:bg-blue-600 rounded-full transition duration-200"
            href="#">Rush Orders</a>
            <a className="inline-block px-20 py-5 text-lg text-white text-center font-bold bg-blue-500 mb-6 hover:bg-blue-600 rounded-full transition duration-200"
              href="#">Sleeved Orders</a>
            <a className="inline-block px-20 py-5 text-lg text-white text-center font-bold bg-blue-500 rounded-full mb-6 hover:bg-blue-600 hover:border-none  transition duration-200"
